...
Use this skill as **extra guidance when turning Figma into code**. **Global rules** (stack, token locations, `cn`, `components/ui`, React 19, etc.) live in **[CURSOR.md](../../../CURSOR.md)** and take precedence.
