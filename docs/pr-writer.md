...
The final body must follow **[.github/pull_request_template.md](../../../.github/pull_request_template.md)** exactly: **section titles, order, and checkbox labels**. Do not add sections that are not in the template.
...
2. **Full body**: complete markdown filled from [.github/pull_request_template.md](../../../.github/pull_request_template.md), in one copy-paste block.
...
Quality: prose should read well in **Korean**. If something conflicts with [AGENTS.md](../../../AGENTS.md), mention it under **기타사항**.
