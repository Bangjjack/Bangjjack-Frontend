...
- **Not vendored in this repo (copy from the Figma Cursor plugin cache under `~/.cursor/plugins/.../skills/` if needed):** `figma-generate-design` (full screens in Figma from code), `figma-code-connect`, `figma-create-design-system-rules`.
