...
interface AuthState {
  ...
  setAuth: (accessToken: string, userId: number, username: string, isOnboarded: boolean) => void;
...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  setAuth: (accessToken, userId, username, isOnboarded) => {
    ...
    set({ userId, username, isAuthenticated: true, isOnboardingCompleted });
  },
  ...
  clearAuth: () => {
    ...
    set({ userId: null, username: null, isAuthenticated: false, isOnboardingCompleted: false });
  },
}));
